...
import 'dart:convert';
import 'detail_page_internasional.dart';
...
class _InternasionalPageState extends State<InternasionalPage> {
  ...
  Future<void> fetchNews() async {
    final response = await http.get(Uri.parse('https://api-berita-indonesia.vercel.app/republika/internasional/'));
  ...
  void navigateToDetailPage(dynamic post) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => DetailPageInternasional(
          post: post,
          key: UniqueKey(),
        ),
      ),
